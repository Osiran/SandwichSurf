        ...
        <div class="main">
            ...
            <div class="js">
                ...
                <div class="form1" id="slide1">
                    ...
                    <?php
                        foreach($breads as $bread){
                            echo "
                            <input type='radio' class='bread' name='' value=''>
                            <label for=''></label><br>
                            ";
                        }
                    ?>
                ...
                <div class="form2" id="slide2">
                    ...
                    <?php
                        foreach($cheeses as $chesse){
                            echo "
                            <input type='radio' class='cheese' name='' value=''>
                            <label for=''></label><br>
                            ";
                        }
                    ?>
                ...
                <div class="form3" id="slide3">
                    ...
                    <?php
                        foreach($meats as $meat){
                            echo "
                            <input type='radio' class='meat' name='' value=''>
                            <label for=''></label><br>
                            ";
                        }
                    ?>
                ...
                <div class="form4" id="slide4">
                    ...
                    <?php
                        foreach($sauces as $sauce){
                            echo "
                            <input type='radio' class='sauce' name='' value=''>
                            <label for=''></label><br>
                            ";
                        }
                    ?>
                ...
                <div class="form5" id="slide5">
                    ...
                    <?php
                        foreach($vegetables as $vegetable){
                            echo "
                            <input type='checkbox' class='vegetables' name='' value=''>
                            <label for=''></label><br>
                            ";
                        }
                    ?>
